...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SRCLK_Pin|RCLK_Pin|OE_Pin|SER_Pin
  ...
  /*Configure GPIO pins : SRCLK_Pin SER_Pin LORA_CS_Pin */
  GPIO_InitStruct.Pin = SRCLK_Pin|SER_Pin|LORA_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : RCLK_Pin OE_Pin */
  GPIO_InitStruct.Pin = RCLK_Pin|OE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : ACDET_Pin SD_DET_Pin PB7 */
  GPIO_InitStruct.Pin = ACDET_Pin|SD_DET_Pin|GPIO_PIN_7;
